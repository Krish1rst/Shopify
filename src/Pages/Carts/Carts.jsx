...
function Carts() {
  ...
  return (
    <section className='mx-8 sm:mx-10 md:mx-14 lg:mx-18 xl:mx-24 my-6 sm:my-8 md:my-12 lg:my-24'>
      ...
      <div className='flex flex-col lg:flex-row mb-24 mt-10 gap-12 border rounded-2xl'>
        <div className='bg-white flex flex-col overflow-x-auto w-full xl:w-4/6 '>
            {featuredData.map((item)=>(
                ...
                <div> <AmountSelect /></div>
                  <button className="text-blue-500 hover:underline text-sm font-normal text-left">remove</button>
                </div>
