...
function Carts() {
  ...
  <div className='bg-white flex flex-col overflow-x-auto w-4/6 my-4 pr-8'>
      ...
      <div className='bg-blue-50 w-2/6 h-fit rounded-3xl px-8'>
          ...
          <div className="mt-8 relative py-8 flex justify-between ">
