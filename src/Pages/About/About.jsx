...
function About() {
  ...
  return (
    <div className={` transition-all duration-300 transform transition-delay-250 flex items-center justify-center pt-40 ${isDarkMode ?'bg-slate-800':'bg-white'} transition-colors`}>
