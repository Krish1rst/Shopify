  ...
  <div className='flex flex-col mx-4 sm:mx-8 md:mx-12 lg:mx-18 xl:mx-24 my-10  md:my-16 lg:my-24 transition-all duration-300 transform transition-delay-250'>
     <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 mt-4 sm:mt-0 ">
        <div className="w-full h-fit">
            ...
            <button className={`px-4 py-3 my-6 sm:my-0  tracking-wider font-medium text-sm rounded-md transition-all transform hover:scale-105 active:scale-100 hover:shadow-md focus:outline-none focus:ring focus:border-purple-800 ${isDarkMode ?'bg-pink-500 text-gray-800':'bg-blue-500 text-blue-50 '}`}>
