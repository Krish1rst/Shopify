...
function Home() {
  return (
   <div className='flex flex-col '>
     <div className="flex  gap-6 h-screen mx-20 mt-8 ">
      <div className="w-1/2 py-[6rem]  ">
    ...
    <div className="w-1/2 bg-white flex items-center justify-end ml-7  overflow-hidden">
