...
function Filter() {
  ...
  return (
    ...
    <div className='flex items-center justify-center'>
        <button onClick={(currentData)=>handleFilter(currentData)} className={` w-full py-2 font-medium  text-sm rounded-xl transition-all transform hover:scale-95 active:scale-100 hover:shadow-md focus:outline-none focus:ring  ${isDarkMode ?'bg-green-400':'focus:border-blue-800 text-white bg-blue-500 '}`}>  
        Search </button>
     </div>
