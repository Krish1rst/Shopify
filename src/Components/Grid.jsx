  ...
  return (
    <>
      ...
      {currentData.map((item) => (
            ...
            key={item.id}
            className={`grid-layout-style flex justify-center rounded-xl place-content-center  overflow-hidden shadow-2xl transition-transform transform hover:scale-95 hover:shadow-lg  duration-300 px-4 py-1 ${isDarkMode ?'bg-slate-900':''}`}
          >
            <div  >
              ...
              <div className='pt-6 relative'>
                ...
                <div className={`absolute top-4 left-0 right-0 h-px  ${isDarkMode ?'bg-slate-700':'bg-gray-300'}`}></div>
              </div>
